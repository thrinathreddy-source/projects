...
/** Hourly, matching the scraper — see app/collections/[slug]/page.tsx for the
 * full reasoning. /companies was the worst case measured: prerendered at build
 * and then served for three and a half days while the sitemap called it
 * daily-changing. */
